...
att.SortOrder = 2.7
att.Slot = "kar98k_bayonet"

att.AutoStats = true

att.Model = "models/weapons/cultist/upgrades/a_kar98k_bayonet.mdl"
att.WorldModel = "models/weapons/cultist/upgrades/w_kar98k_bayonet.mdl"
