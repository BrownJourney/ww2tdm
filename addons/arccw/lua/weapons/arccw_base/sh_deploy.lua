function SWEP:Deploy()
    ...
    -- self.Owner.RestrictReadyAnim = false
    ...
    if !self:GetOwner():InVehicle() then
        ...
        if self.Animations[r_anim] and self.UnReady and self:Clip1() > 0 and gamestate.Get() != GS_ROUND_PLAYING then
            ...
            -- self.Owner.RestrictReadyAnim = true
