...
function SWEP:SetupDataTables()
    ...
    self:NetworkVar("Float", 9, "InternalReload")
...
function SWEP:CanTacSprint()
    return self.Owner:GetTrait() == TRAIT_TACSPRINT and (self.HoldtypeActive == "smg" or self.HoldtypeActive == "ass" or self.HoldtypeActive == "shotgun")
end
