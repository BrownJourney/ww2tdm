...
SWEP.PrintName = "MkB-42"
SWEP.TrueName = "MkB-42"
SWEP.Trivia_Class = ""
SWEP.Trivia_Desc = ""
...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_mkb42.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_mkb42.mdl"
...
SWEP.Recoil = 2 -- общий рекоил
SWEP.RecoilSide = 0.8 -- рекоил в стороны
SWEP.RecoilRise = 0.2 -- рекоил вверх
...
-- Я ебал это все, нужно писать свой пак оружия
SWEP.Kostil = true
SWEP.Attachments = {
    [1] =  {
        PrintName = "Optic", -- print name
        DefaultAttName = "Iron Sights",
        Slot = {"mkb_optic"}, -- what kind of attachments can fit here, can be string or table
        Bone = "ValveBiped.Bip01_R_Hand", -- relevant bone any attachments will be mostly referring to
        Offset = {
            vpos = Vector(5, 1.5, -5),
            vang = Angle(-180, -190, -10),
            wpos = Vector(0, 0, 0),
            wang = Angle(0, 0, 0)
        },
        BoneMerge = false,
