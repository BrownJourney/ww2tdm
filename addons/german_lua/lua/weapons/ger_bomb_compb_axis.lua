...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_compb_axis.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_compb_axis.mdl"
...
SWEP.ShootEntity = "ww2_nade_german_compb_axis"
