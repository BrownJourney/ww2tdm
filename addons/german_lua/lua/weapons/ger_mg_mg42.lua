...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_mg42.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_mg42.mdl"
...
SWEP.Primary.ClipSize = 250 -- DefaultClip is automatically set.
SWEP.ExtendedClipSize = 250 -- extended mag
...
--RECOIL
-----------
SWEP.Recoil = 7 -- общий рекоил
SWEP.RecoilSide = 1.6 -- рекоил в стороны
...
SWEP.ShootSound = "weapons/cultist/mg42/mg42_fp.wav"
SWEP.ShootSoundSilenced = "weapons/hunting/sup.wav"
SWEP.DistantShootSound = "weapons/cultist/mg42/mg42_dist.wav"
...
SWEP.IronSightsPos = Vector( -0.0729, 5.827, -3.6508 )
SWEP.IronSightsAng = Vector( 0.0342, -0.0002, -0.0791 )



SWEP.IronSightStruct = {
    Pos = Vector(-2.846, 0, 1.159),
    Ang = Angle(0, 0, 0),
    Magnification = 1,
