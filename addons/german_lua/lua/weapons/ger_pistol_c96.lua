...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_c96.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_c96.mdl"
...
SWEP.Attachments = {
    ...
    [2] =  {
        PrintName = "Stocks", -- print name
        DefaultAttName = "None",
        Slot = {"stock_c96"}, -- what kind of attachments can fit here, can be string or table
        Bone = "ValveBiped.Bip01_R_UpperArm", -- relevant bone any attachments will be mostly referring to
        Offset = {
            vpos = Vector(-3.089, 1.406, 1.879), -- offset that the attachment will be relative to the bone
            vang = Angle(0.3, 0, 0),
