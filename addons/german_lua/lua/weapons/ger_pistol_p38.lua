...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_p38.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_p38.mdl"
...
SWEP.Range = 90 -- in METRES effective range
...
SWEP.Primary.ClipSize = 8 -- DefaultClip is automatically set.
SWEP.ExtendedClipSize = 8 -- extended mag
SWEP.ReducedClipSize = 1 -- smaller mag
SWEP.Primary.Ammo = "ger_pistol" -- what ammo type the gun uses
--
...
SWEP.ShootSound = "weapons/cultist/p38/p38_fp.wav"
SWEP.ShootSoundSilenced = "weapons/hunting/sup.wav"
SWEP.DistantShootSound = "weapons/cultist/p38/p38_dist.wav"
...
SWEP.MuzzleEffect = {"port_smoke", "muzzleflash_luger_1p_core", "muzzleflash_luger_1p_spark_trail", "barrel_smoke_trail"}
