...
SWEP.PrintName = "Panzerfaust-30"
SWEP.TrueName = "Panzerfaust-30"
SWEP.Trivia_Class = ""
SWEP.Trivia_Desc = ""
...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_panzerfaust_30.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_panzerfaust30.mdl"

SWEP.ShootEntity = "ww2_pjojectile_panzerfaust30" -- entity to fire, if any
...
-- "muzzleflash_smoke_medium_variant_1", "muzzleflash_sparks_variant_6"
SWEP.MuzzleEffect = {}
...
SWEP.IronSightStruct = {
    Pos = Vector(-3.161, 0, 0.039),
    Ang = Angle(0.56, 0, 6.331),
    Magnification = 1,
