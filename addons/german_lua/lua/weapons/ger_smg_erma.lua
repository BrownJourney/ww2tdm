...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_erma.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_erma.mdl"
...
SWEP.MuzzleVelocity = 380   -- projectile or phys bullet muzzle velocity
...
SWEP.RecoilPunchBackMax = 0.8 -- насколько оружие отходит к камере при стрельбе. Визуальный эффект.
...
SWEP.ShootSound = "weapons/cultist/erma/mp40_fp.wav"
SWEP.ShootSoundSilenced = "weapons/hunting/sup.wav"
SWEP.DistantShootSound = "weapons/cultist/emp44/mp40_dist.wav"
