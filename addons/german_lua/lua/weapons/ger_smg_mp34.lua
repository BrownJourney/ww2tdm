...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_mp34.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_mp34.mdl"
...
SWEP.MuzzleVelocity = 410 -- projectile or phys bullet muzzle velocity
...
SWEP.RecoilSide = 0.6 -- рекоил в стороны
