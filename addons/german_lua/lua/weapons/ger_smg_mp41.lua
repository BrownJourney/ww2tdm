...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_mp41.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_mp41.mdl"
...
SWEP.Primary.ClipSize = 32  -- DefaultClip is automatically set.
SWEP.ExtendedClipSize = 32  -- extended mag
SWEP.ReducedClipSize = 1 -- smaller mag
SWEP.Primary.Ammo = "ger_smg" -- what ammo type the gun uses
--
SWEP.Delay = 60 / 500 -- RPM

--RECOIL
-----------
SWEP.Recoil = 1.6 -- общий рекоил
SWEP.RecoilSide = 0.2 -- рекоил в стороны
SWEP.RecoilRise = 1.2 -- рекоил вверх
...
SWEP.ShootSound = "weapons/cultist/mp40/mp40_fp.wav"
SWEP.ShootSoundSilenced = "weapons/hunting/sup.wav"
SWEP.DistantShootSound = "weapons/cultist/mp40/mp40_dist.wav"
...
SWEP.IronSightsPos = Vector(-4.381, 0, 0.4)
SWEP.IronSightsAng = Vector(0.1, 0, 0)

SWEP.IronSightStruct = {
    Pos = Vector(-4.381, 0, 0.4),
    Ang = Angle(0.1, 0, 0),
    Magnification = 1,
