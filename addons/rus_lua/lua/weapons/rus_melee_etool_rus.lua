...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_etool_sov.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_etool_sov.mdl"
...
SWEP.Animations = {
    ...
    ["bash"] = {
	Source = {"swing_center_hit", "swing_left_hit", "swing_right_hit"}
    },
    ["sprint"] = {
	Source = {"base_sprint"}
    },	
