...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_dp28.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_dp28.mdl"
...
SWEP.Primary.ClipSize = 47 -- DefaultClip is automatically set. /n //ClipSize = 100 -- DefaultClip is automatically set.
SWEP.ExtendedClipSize = 47 -- extended mag
...
SWEP.Sway = 6 -- Насколько сильно дрожат руки при прицеливание
...
SWEP.ShootSound = "weapons/cultist/dp27/lewis_fp.wav"
SWEP.ShootSoundSilenced = "weapons/hunting/sup.wav"
SWEP.DistantShootSound = "weapons/cultist/dp27/lewis_dist.wav"
...
SWEP.BipodDispersion = 0.2 -- Bipod dispersion for Integral bipods
