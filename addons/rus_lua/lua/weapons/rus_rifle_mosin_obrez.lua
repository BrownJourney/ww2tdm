...
SWEP.TrueName = "Mosin-Nagant Obrez"
SWEP.Trivia_Class = ""
SWEP.Trivia_Desc = ""
...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_mosin_obrez.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_mosin_obrez.mdl"
