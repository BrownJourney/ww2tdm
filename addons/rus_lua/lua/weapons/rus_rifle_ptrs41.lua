...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_ptrs.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_ptrs.mdl"
...
SWEP.ShootSound = "weapons/cultist/ptrs/ptrsfiremain_temp.wav"
SWEP.ShootSoundSilenced = "weapons/hunting/sup.wav"
SWEP.DistantShootSound = "weapons/cultist/ptrs/ptrs_shot_body.wav"
...
SWEP.BipodDispersion = 0 -- Bipod dispersion for Integral bipods
SWEP.BipodRecoil = 0 -- Bipod recoil for Integral bipods
