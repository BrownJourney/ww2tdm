...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_avs36.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_avs36.mdl"
...
SWEP.Range = 600 -- in METRES effective range
...
SWEP.Primary.ClipSize = 15 -- DefaultClip is automatically set. /n //ClipSize = 10 -- DefaultClip is automatically set.
SWEP.ExtendedClipSize = 15 -- extended mag
...
SWEP.ShootSound = "weapons/cultist/avs36/sks_fp.wav"
SWEP.ShootSoundSilenced = "weapons/hunting/sup.wav"
SWEP.DistantShootSound = "weapons/cultist/avs36/sks_dist.wav"
