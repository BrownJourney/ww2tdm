...
SWEP.PrintName = "SVT-38"
SWEP.TrueName = "SVT-38"
SWEP.Trivia_Class = ""
SWEP.Trivia_Desc = ""
...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_svt38.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_svt38.mdl"
...
SWEP.Range = 450 -- in METRES effective range
...
SWEP.Sway = 0.65 -- Насколько сильно дрожат руки при прицеливание
...
SWEP.ShootSound = "weapons/cultist/svt38/sks_fp.wav"
SWEP.ShootSoundSilenced = "weapons/hunting/sup.wav"
SWEP.DistantShootSound = "weapons/cultist/svt38/sks_dist.wav"
...
SWEP.Attachments = {
    [1] =  {
        ...
        Slot = {"optic_svt"}, -- what kind of attachments can fit here, can be string or table
        Bone = "sights_svt40", -- relevant bone any attachments will be mostly referring to
        Offset = {
