...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_sawedoff.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_sawedoff.mdl"
...
SWEP.Primary.ClipSize = 2 -- DefaultClip is automatically set. /n //ClipSize = 2 -- DefaultClip is automatically set.
