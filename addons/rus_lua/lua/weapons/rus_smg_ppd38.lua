...
SWEP.PrintName = "PPD-38"
SWEP.TrueName = "PPD-38"
SWEP.Trivia_Class = ""
SWEP.Trivia_Desc = ""
...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_ppd38.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_ppd38.mdl"
...
SWEP.Primary.ClipSize = 73  -- DefaultClip is automatically set. /n //ClipSize = 32  -- DefaultClip is automatically set.
...
SWEP.RecoilRise = 0.8 -- рекоил вверх
SWEP.MaxRecoilBlowback = -1 -- хз
SWEP.VisualRecoilMult = 1 -- увеличение рекоила для первого лица. Визуальный эффект 
SWEP.RecoilPunch = 0.1 -- Насколько шатает камеру. 
SWEP.RecoilPunchBackMax = 0.9 -- насколько оружие отходит к камере при стрельбе. Визуальный эффект.
...
SWEP.Sway = 0.55 -- Насколько сильно дрожат руки при прицеливание
