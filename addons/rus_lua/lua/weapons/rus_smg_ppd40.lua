...
SWEP.PrintName = "PPD-40"
SWEP.TrueName = "PPD-40"
SWEP.Trivia_Class = ""
SWEP.Trivia_Desc = ""
...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_ppd40.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_ppd40.mdl"
...
SWEP.RecoilPunchBackMax = 0.85 -- насколько оружие отходит к камере при стрельбе. Визуальный эффект.
