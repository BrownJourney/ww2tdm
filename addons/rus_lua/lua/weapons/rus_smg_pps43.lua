...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_pps43.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_pps43.mdl"
...
SWEP.Primary.ClipSize = 35  -- DefaultClip is automatically set. /n //ClipSize = 32  -- DefaultClip is automatically set.
SWEP.ExtendedClipSize = 35  -- extended mag
...
--RECOIL
SWEP.Recoil = 1.55 -- общий рекоил
SWEP.RecoilSide = 0.75 -- рекоил в стороны
SWEP.RecoilRise = 0.75 -- рекоил вверх
SWEP.MaxRecoilBlowback = -1 -- хз
SWEP.VisualRecoilMult = 0.78 -- увеличение рекоила для первого лица. Визуальный эффект 
SWEP.RecoilPunch = 0 -- Насколько шатает камеру. 
SWEP.RecoilPunchBackMax = 0.78 -- насколько оружие отходит к камере при стрельбе. Визуальный эффект.
...
SWEP.ShootSound = "weapons/cultist/pps43/ump45_fp.wav"
SWEP.ShootSoundSilenced = "weapons/hunting/sup.wav"
SWEP.DistantShootSound = "weapons/cultist/pps43/ump45_dist.wav"
...
SWEP.MuzzleEffect = {"muzzleflash_thompson_1p_core", "barrel_smoke_trail_b", "muzzle_smoke_d"}
