...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_ppsh41.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_ppsh41.mdl"
...
SWEP.PhysBulletMuzzleVelocity = 488 
SWEP.MuzzleVelocity = 488  -- projectile or phys bullet muzzle velocity
...
SWEP.Primary.ClipSize = 71  -- DefaultClip is automatically set. /n //ClipSize = 32  -- DefaultClip is automatically set.
SWEP.ExtendedClipSize = 71  -- extended mag
SWEP.ReducedClipSize = 32 -- smaller mag
...
--RECOIL
SWEP.Recoil = 1.7 -- общий рекоил
SWEP.RecoilSide = 0.75 -- рекоил в стороны
SWEP.RecoilRise = 0.75 -- рекоил вверх
...
SWEP.Sway = 0.4 -- Насколько сильно дрожат руки при прицеливание
...
SWEP.MoveDispersion = 750 -- Разброс при движении + к базовому
...
SWEP.ShootSound = "weapons/cultist/ppsh41/mp5k_fp.wav"
SWEP.ShootSoundSilenced = "weapons/hunting/sup.wav"
SWEP.DistantShootSound = "weapons/cultist/ppsh41/mp5k_dist.wav"
...
SWEP.ActivePos = Vector(2.5, 2, -0.5)
...
SWEP.IronSightsPos = Vector(0, 0, -0.02)
SWEP.IronSightsAng = Vector(0.379, 0, 0)
...
SWEP.Hook_TranslateAnimation = function(wep, anim)
    ...
    if anim and cap == "ppsh_stick_mag" then
        return anim .. "_stick"
    end
end
...
-- BASE
    ["ready_stick"] = {
        Source = "base_ready_stick",
    },

    ["draw_stick"] = {
        Source = "base_draw_stick",
    },
    ["draw_empty_stick"] = {
        Source = "base_draw_empty_stick",
    },	
    ["holster_stick"] = {
        Source = "base_holster_stick",
    },
    ["holster_empty_stick"] = {
        Source = "base_holster_empty_stick",
    },

    ["idle_stick"] = {
        Source = "base_idle_stick",
    },
	
    ["idle_empty_stick"] = {
        Source = "base_idle_empty_stick",
    },
	
    ["fire_stick"] = {
    Source = {"base_fire_stick"},
	ShellEjectAt = 0,
    },
	
    ["fire_last_stick"] = {
    Source = "base_fire_last_stick",
	 ShellEjectAt = 0,
    },	
	
    ["fire_empty_stick"] = {
    Source = "base_dryfire_stick",
    },	

    ["reload_stick"] = {
        Source = "base_reload_stick",
    },
	
    ["reload_empty_stick"] = {
        Source = "base_reloadempty_stick",	
    },
...
--IRON
    ...
    ["idle_iron_stick"] = {
        Source = "iron_idle_stick",
    },
		
    ["fire_iron_stick"] = {
        Source = {"iron_fire_stick"},
    },
	
    ["fire_iron_last_stick"] = {
        Source = {"base_fire_last_stick"},
    },

--IRON_EMPTY
	
    ["idle_iron_empty_stick"] = {
        Source = "iron_empty_idle_stick",
    },
	
    ["fire_iron_empty_stick"] = {
        Source = {"iron_dryfire_stick"},
    },

--SPRINT	
			
    ["idle_sprint_stick"] = {
        Source = "base_sprint_stick",
    },
	
    ["idle_sprint_empty_stick"] = {
        Source = "base_sprint_empty_stick",
    },		
