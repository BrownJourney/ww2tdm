...
local V = {
	Name = "Opel Blitz",
	Model = "models/ww2/vehicles/ger/opelblitz/opel_blitz.mdl",
	Class = "gmod_sent_vehicle_fphysics_base",
	Category = Category,
	SpawnAngleOffset = 90,
	...
	Members = {
		...
		CustomWheelModel_R = "models/ww2/vehicles/ww2_r_wheel.mdl",
		CustomWheelPosFL = Vector(90,34,12),
		CustomWheelPosFR = Vector(90,-34,12),
		CustomWheelPosRL = Vector(-57,34,13),
		CustomWheelPosRR = Vector(-57,-34,13),
		CustomWheelAngleOffset = Angle(0,0,0),
   
		SeatOffset = Vector(30,-12,78),
		SeatPitch = 8,
		SeatYaw = 90,
		...
		snd_pitch = 1,
		snd_idle = "ww2/vehicle/blitz/blitz_idle.wav",
 
		snd_low = "ww2/vehicle/blitz/blitz_full.wav",
		snd_low_revdown = "ww2/vehicle/blitz/blitz_full.wav",
		snd_low_pitch = 0.9,
 
		snd_mid = "ww2/vehicle/blitz/blitz_idle.wav",
		snd_mid_gearup = "ww2/vehicle/blitz/blitz_idle.wav",
		snd_mid_pitch = 1,
...
list.Set( "simfphys_vehicles", "sim_fphys_opel", V )
 
local V = {
	Name = "Zis 5",
	Model = "models/ww2/vehicles/sov/zis_5/zis_5.mdl",
	Class = "gmod_sent_vehicle_fphysics_base",
	Category = Category,
	SpawnAngleOffset = 90,
	...
	Members = {
		...
		CustomWheelModel = "models/ww2/vehicles/ww2_f_wheel.mdl",
		CustomWheelModel_R = "models/ww2/vehicles/ww2_r_wheel.mdl",
		CustomWheelPosFL = Vector(98,32,8),
		CustomWheelPosFR = Vector(98,-32,8),
		CustomWheelPosRL = Vector(-57,35,8),
		CustomWheelPosRR = Vector(-57,-35,8),
		CustomWheelAngleOffset = Angle(0,0,0),
 
		SeatOffset = Vector(8,-12,72),
		SeatPitch = 8,
		SeatYaw = 90,
		...
		PassengerSeats = {
			...
			{
				pos = Vector(-110,-20,58),
				ang = Angle(0,-90,0)
			},
			{
				pos = Vector(-110,15,58),
				ang = Angle(0,-90,0)
			},
		},
...
list.Set( "simfphys_vehicles", "sim_fphys_zis", V )