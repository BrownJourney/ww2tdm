...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_m50.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_m50.mdl"
...
SWEP.PhysBulletMuzzleVelocity = 280  
...
--RECOIL
SWEP.Recoil = 2.4 -- общий рекоил
SWEP.RecoilSide = 0.65 -- рекоил в стороны
...
SWEP.Sway = 0.35 -- Насколько сильно дрожат руки при прицеливание
...
SWEP.Attachments = {
    [1] =  {
        ...
        DefaultAttName = "Default magazine",
        Slot = {"m50_mag"}, -- what kind of attachments can fit here, can be string or table
