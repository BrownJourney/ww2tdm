...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_m1919.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_m1919.mdl"
...
SWEP.Recoil = 7.5 -- общий рекоил
SWEP.RecoilSide = 2 -- рекоил в стороны
SWEP.RecoilRise = 2 -- рекоил вверх
SWEP.MaxRecoilBlowback = -1 -- хз
SWEP.VisualRecoilMult = 0.5 -- увеличение рекоила для первого лица. Визуальный эффект 
