...
SWEP.PrintName = "SW1917"
SWEP.TrueName = "SW1917"
SWEP.Trivia_Class = ""
SWEP.Trivia_Desc = ""
...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_sw1917.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_sw1917.mdl"
...
SWEP.Primary.Ammo = "usa_revolver" -- what ammo type the gun uses
--
...
SWEP.CaseBGs_OnlyReload = true
SWEP.StripperClipBGs = {}

SWEP.Attachments = {
    [1] =  {
        PrintName = "Clip", -- print name
        DefaultAttName = "None",
        Slot = {"sw1917_clip"}, -- what kind of attachments can fit here, can be string or table
...
SWEP.IronSightStruct = {
    Pos = Vector(-3.3, 0, 1.45),
    Ang = Angle(-1.2, 0, 5.599),
    Magnification = 1,
