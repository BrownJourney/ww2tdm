...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_springfield.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_springfield.mdl"
...
SWEP.ShootSound = "weapons/cultist/springfield/springfield_fp.wav"
...
SWEP.Attachments = {
    [1] =  {
        ...
        Installed = "optic_springfield_iron",
