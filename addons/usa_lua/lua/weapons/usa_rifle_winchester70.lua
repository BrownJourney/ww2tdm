...
SWEP.PrintName = "Winchester 70"
SWEP.TrueName = "Winchester 70"
SWEP.Trivia_Class = ""
SWEP.Trivia_Desc = ""
...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_winchester70.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_winchester70.mdl"
...
SWEP.ShootSound = "weapons/cultist/m1917/m1917_fp.wav"
SWEP.ShootSoundSilenced = "weapons/hunting/sup.wav"
SWEP.DistantShootSound = "weapons/cultist/m1917/m1917_dist.wav"
...
SWEP.Attachments = {
    [1] =  {
        ...
        Slot = {"springfield_optic"}, -- what kind of attachments can fit here, can be string or table
    ...
    [2] =  {
        ...
        DefaultAttName = "None",
        Slot = {"springfield_gl"}, -- what kind of attachments can fit here, can be string or table
        Bone = "A_Optic", -- relevant bone any attachments will be mostly referring to
        Offset = {
            vpos = Vector(-3.089, 1.406, 1.879), -- offset that the attachment will be relative to the bone
            vang = Angle(0.3, 0, 0),
    ...
    [3] =  {
        ...
        DefaultAttName = "None",
        Slot = {"springfield_bayonet"}, -- what kind of attachments can fit here, can be string or table
        Bone = "A_Optic", -- relevant bone any attachments will be mostly referring to
        Offset = {
            vpos = Vector(-3.089, 1.406, 1.879), -- offset that the attachment will be relative to the bone
            vang = Angle(0.3, 0, 0),
    ...
    [4] =  {
        ...
        DefaultAttName = "None",
        Slot = {"cloth_springfield"}, -- what kind of attachments can fit here, can be string or table
        Bone = "A_Optic", -- relevant bone any attachments will be mostly referring to
        Offset = {
            vpos = Vector(-3.089, 1.406, 1.879), -- offset that the attachment will be relative to the bone
            vang = Angle(0.3, 0, 0),
    ...
    [5] =  {
        PrintName = "Bolt", -- print name
        DefaultAttName = "Default",
        Slot = {"bolt_springfield"}, -- what kind of attachments can fit here, can be string or table
        Bone = "A_Optic", -- relevant bone any attachments will be mostly referring to
        Offset = {
            vpos = Vector(-3.089, 1.406, 1.879), -- offset that the attachment will be relative to the bone
            vang = Angle(0.3, 0, 0),
    ...
    [6] =  {
        ...
        DefaultAttName = "None",
        Slot = {"sling_springfield"}, -- what kind of attachments can fit here, can be string or table
        Bone = "A_Optic", -- relevant bone any attachments will be mostly referring to
        Offset = {
            vpos = Vector(-3.089, 1.406, 1.879), -- offset that the attachment will be relative to the bone
            vang = Angle(0.3, 0, 0),
    ...
    [7] =  {
        ...
        DefaultAttName = "None",
        Slot = {"mag_springfield"}, -- what kind of attachments can fit here, can be string or table
        Bone = "A_Optic", -- relevant bone any attachments will be mostly referring to
        Offset = {
            vpos = Vector(-3.089, 1.406, 1.879), -- offset that the attachment will be relative to the bone
            vang = Angle(0.3, 0, 0),
