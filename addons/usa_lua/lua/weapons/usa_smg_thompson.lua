...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_thompson.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_thompson.mdl"
...
SWEP.Recoil = 1.8 -- общий рекоил
SWEP.RecoilSide = 0.5 -- рекоил в стороны
SWEP.RecoilRise = 0.7 -- рекоил вверх
...
--SWEP.ShootSound = "weapons/cultist/mkb42/stg44_fp.wav"
SWEP.ShootSoundSilenced = "weapons/hunting/sup.wav"
SWEP.DistantShootSound = "weapons/cultist/mkb42/stg44_dist.wav"
...
SWEP.Attachments = {
    [1] =  {
        ...
        Installed = "optic_thompson",
        Slot = {"thompson_optic"}, -- what kind of attachments can fit here, can be string or table
    ...
    [2] =  {
        ...
        Installed = "mag_thompson_20",
        Slot = {"thompson_mag"}, -- what kind of attachments can fit here, can be string or table
        Bone = "A_Optic", -- relevant bone any attachments will be mostly referring to
        Offset = {
            vpos = Vector(-3.089, 1.406, 1.879), -- offset that the attachment will be relative to the bone
            vang = Angle(0.3, 0, 0),
    ...
    [3] =  {
        ...
        DefaultAttName = "None",
        Installed = "grip_thompson_standart",
        Slot = {"thompson_grip"}, -- what kind of attachments can fit here, can be string or table
        Bone = "A_Optic", -- relevant bone any attachments will be mostly referring to
        Offset = {
            vpos = Vector(-3.089, 1.406, 1.879), -- offset that the attachment will be relative to the bone
            vang = Angle(0.3, 0, 0),
