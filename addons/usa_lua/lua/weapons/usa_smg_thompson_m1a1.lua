...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cultist/v_thompson_m1a1.mdl"
SWEP.WorldModel = "models/weapons/cultist/w_thompson_m1a1.mdl"
...
SWEP.Recoil = 2.2 -- общий рекоил
SWEP.RecoilSide = 0.8 -- рекоил в стороны
SWEP.RecoilRise = 1 -- рекоил вверх
SWEP.MaxRecoilBlowback = -1 -- хз
SWEP.VisualRecoilMult = 0.99 -- увеличение рекоила для первого лица. Визуальный эффект 
...
-- BASE
    ...
    ["fire"] = {
        Source = {"base_fire", "base_fire_2", "base_fire_3"},
    	ShellEjectAt = 0,
    },
