...
CLASS.Variants = {
	[1] = {
		Name = "Support",
		Weapons = {"ger_battlerifle_mkb42", "ger_grenade_stielhandgranate", "ger_grenade_stielhandgranate", "ger_melee_k98kbayonet"},
		Level = 4,
		Cost = 4
	},
	[2] = {
		Name = "Assault",
		Weapons = {"ger_battlerifle_mkb42", "ger_grenade_splintering_stielhandgranate", "ger_grenade_splintering_stielhandgranate", "ger_grenade_nebelhandgranate", "ger_melee_k98kbayonet"},
		Level = 6,
		Cost = 5
	},
}