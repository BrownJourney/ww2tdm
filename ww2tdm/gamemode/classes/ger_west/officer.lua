...
CLASS.Variants = {
	...
	[2] = {
		Name = "Sturm Officer",
		Weapons = {"ger_battlerifle_stg44", "ger_pistol_lugerp08", "ger_grenade_splintering_stielhandgranate", "ger_grenade_splintering_stielhandgranate", "ger_grenade_nebelhandgranate", "beacon_placer" },
		Level = 8,
		Cost = 5
	},
}