...
CLASS.WalkSpeed = 100
CLASS.RunSpeed = 185
CLASS.Weapons = {"ger_smg_mp40", "ger_grenade_stielhandgranate", "ger_melee_etool_ger"}
CLASS.Variants = {
	[1] = {
		Name = "Flanker",
		RunSpeed = 215,
		Level = 3,
		Cost = 4,
		Weapons = {"ger_smg_mp41", "ger_grenade_nebelhandgranate", "ger_grenade_splintering_stielhandgranate", "ger_melee_etool_ger"}
	},
	[2] = {
		Name = "Mid Range",
		Level = 6,
